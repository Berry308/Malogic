...
public:
	...
	UFUNCTION(BlueprintPure, Category = "Magic Weapon")
	float GetMagicCircleBuildingRate() const { return MagicCircleBuildingRate; }
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "Magic Weapon", meta = (ClampMin = "0.01"))
	float MagicCircleBuildingRate = 1.0f;
