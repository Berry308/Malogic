...
struct FAbilityTagRelationship
{
	...
	/** If an ability has the tag, this is implicitly added to the activation required tags of the ability隐式前提条件 */
	UPROPERTY(EditAnywhere, Category = Ability)
	FGameplayTagContainer ActivationRequiredTags;

	/** If an ability has the tag, this is implicitly added to the activation blocked tags of the ability隐式阻塞条件 */
	UPROPERTY(EditAnywhere, Category = Ability)
...
UCLASS()
class MALOGIC_API UAbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
