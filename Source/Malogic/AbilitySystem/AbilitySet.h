...
public:
	...
	TSubclassOf<UMalogicGameplayAbility> Ability = nullptr;
...
public:
	...
	void TakeFromAbilitySystem(UMalogicAbilitySystemComponent* LyraASC);
...
/**
 * Const修饰表示AbilitySet在运行时是不可变的
 */
UCLASS(BlueprintType, Const)
class MALOGIC_API UAbilitySet : public UPrimaryDataAsset
{
	GENERATED_BODY()
...
public:
	...
	void GiveToAbilitySystem(UMalogicAbilitySystemComponent* LyraASC, FAbilitySet_GrantedHandles* OutGrantedHandles, UObject* SourceObject = nullptr) const;
